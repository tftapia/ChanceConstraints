...
def init_dictionaries(system_flag = False):
    string_path = "/Users/tftapia/Codes/ChanceConstraints/ChanceConstraints-1/"
    ...
    if not system_flag:
        ...
        for wind_index in range(len(zones)): #create a wind generator in each zone
            ...
            system_dict["wind_factor"][wind_index] = system_dict["node_demand"][wind_index]/sum(system_dict["node_demand"])
...
#print(data["node_lines_out"])
#print(data["node_lines_in"])
#print(data["lines_pairnodes"].values())